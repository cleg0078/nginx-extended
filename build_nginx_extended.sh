...
sudo apt install -y mercurial libmaxminddb-dev git gcc g++ gcc-13 g++-13 mold make cmake perl libunwind-dev golang ca-certificates ninja-build build-essential autoconf automake libtool gettext pkg-config libpcre3 libpcre3-dev libxml2 libxml2-dev libcurl4 libgeoip-dev libyajl-dev doxygen checkinstall
...
checkinstall -D --nodoc --reset-uids=yes sudo make install 
